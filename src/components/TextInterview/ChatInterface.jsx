...
import {
  ...
  useInterviewResponse,
} from '@/hooks/apis/useInterview';
...
export function ChatInterface({
  ...
  const { isPending: isQuestionPending, fetchInterviewQuestionMutation } =
    useInterviewQuestion();
  const { isPending: isResponsePending, fetchInterviewResponseMutation } =
    useInterviewResponse();
  const {
    isPending: isFeedbackPending,
    isSuccess: isFeedbackSuccess,
    error: feedbackError,
    fetchInterviewFeedbackMutation,
  } = useInterviewFeedback();
  ...
  const handleEndInterview = async () => {
    setIsLoading(true);
    try {
      const feedback = await fetchInterviewFeedbackMutation({
        type: config.type,
        difficulty: config.difficulty,
