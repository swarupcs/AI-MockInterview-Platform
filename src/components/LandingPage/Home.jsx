          ...
          <div className='container px-4 md:px-6'>
            ...
            <div className='grid gap-8 sm:grid-cols-1 lg:grid-cols-3'>
              <div className='flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow'>
                ...
                <Link href='/demo/text' className='mt-auto'>
              ...
              <div className='flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow'>
                ...
                <Link href='/demo/voice' className='mt-auto'>
                  <Button variant='outline' className='w-full'>
                    Try Voice Interview
                  </Button>
                </Link>
              ...
              <div className='flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-md border border-emerald-100 hover:shadow-lg transition-shadow'>
                <div className='absolute -mt-10 bg-emerald-600 text-white text-xs px-3 py-1 rounded-full'>
                  PREMIUM
                </div>
                <div className='h-14 w-14 rounded-full bg-emerald-100 flex items-center justify-center mb-4'>
                ...
                <Link href='/demo/video' className='mt-auto'>
